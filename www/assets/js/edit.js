if (window.location.href.indexOf('editors/edit') > -1) {
    ...
    depp.define({
        'codeEdit': [
            ...
            , '//cdn.jsdelivr.net/npm/codemirror@5.42.0/mode/pug/pug.js'
            , '//cdn.jsdelivr.net/npm/codemirror@5.42.0/mode/css/css.js'
    ...
    depp.require(['general'], function () {
        ...
        */
        $(document).on('click', '.blog-item li', function (e) {
            ...
            if (postId.includes(mdFile) || postId.includes(datFile) || postId.includes(csvFile) || postId.includes(cssFile)) {
