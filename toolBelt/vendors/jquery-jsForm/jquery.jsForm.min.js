...
if(1===this.length&&(s=t(this).data("jsForm"))){if(0!==i.indexOf("_")&&s[i]){var a=s[i].apply(s,e)
return a}return t.error("Method "+i+" does not exist on jQuery.jsForm"),!1}return this.each(function(){if(s=t.data(this,"jsForm"))return 0!==i.indexOf("_")&&s[i]?s[i].apply(s,e):(t.error("Method "+i+" does not exist on jQuery.jsForm"),!1)})}return this.each(function(){t(this).data("jsForm")||t(this).data("jsForm",new JsForm(this,i))})},t.jsForm=function(i,s){var r=a[i]
