...
depp.require(['poly', 'mustache'], function () { // inside the require
   ...
   c2Temp.innerHTML = `
      {{#items}}
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/INTUITION-dev/intuDS@v1.0.0/bootStrap/css/bootstrapTop.css">
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/INTUITION-dev/intuDS@v1.0.0/bootStrapbootstrap.css">
